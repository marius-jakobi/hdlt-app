...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/customer/{customerId}/addresses/shipping/{addressId}/upload', 'ShippingAddressController@uploadFile')->name('customer.addresses.shipping.details.upload');
